    ...
    return (
        <div id='productCard' className="card m-2 p-2 border border-secondary d-flex justify-content-center" style={{ width: '18rem' }}>
            <div className="d-flex justify-content-center">
                {photo && <img src={`http://localhost/fishing_backend_php/${photo}`} id='productImage' onClick={() => setShow(true)} className="card-img-fluid" style={{ width: '80%', margin: '5px', height: '200px', maxHeight: '200px' }} alt={title} />}
            </div>
